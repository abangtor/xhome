...
class LiveStreamSourceTests(unittest.TestCase):
    ...
    def test_live_camera_uses_embedded_mjpeg_stream_without_token_attribute(self):
        ...
        self.assertIn('"live_mjpeg_last_request_path": self._live_mjpeg_last_request_path', camera_source)
        self.assertIn('"live_mjpeg_last_user_agent": self._live_mjpeg_last_user_agent', camera_source)
        self.assertIn('"live_mjpeg_debug_path": _native_mjpeg_path', camera_source)
        self.assertIn('"live_mjpeg_stream_generation": self._live_mjpeg_stream_generation', camera_source)
        self.assertIn('"live_native_control_stop_commands_sent"', camera_source)
        self.assertIn('"live_native_control_stop_commands_skipped"', camera_source)
        self.assertIn('"live_native_control_stop_commands_failed"', camera_source)
        ...
        self.assertIn('"live_p2p_kcp_window_probe_requests"', camera_source)
        self.assertIn('"live_p2p_unreliable_media_packets"', camera_source)
        self.assertIn('"live_p2p_last_unreliable_media_at"', camera_source)
        self.assertIn('"live_p2p_raw_channel_kcp_segments"', camera_source)
        self.assertIn("_attr_frame_interval = 0.2", camera_source)
        self.assertIn("CameraEntityFeature.STREAM", camera_source)
        self.assertIn("_attr_supported_features = CameraEntityFeature.STREAM", camera_source)
        ...
        self.assertIn("live_p2p_sent_relay_heartbeats", camera_source)
        self.assertIn("live_p2p_sent_peer_heartbeats", camera_source)
        self.assertIn("live_p2p_sent_direct_touches", camera_source)
        self.assertIn("live_p2p_direct_touch_echoes", camera_source)
        self.assertIn("live_p2p_last_direct_touch_echo_at", camera_source)
