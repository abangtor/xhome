...
class LiveStreamSourceTests(unittest.TestCase):
    ...
    def test_live_camera_uses_embedded_mjpeg_stream_without_token_attribute(self):
        ...
        self.assertIn("relay_heartbeat_interval: float = 1.0", live_p2p_source)
        ...
        self.assertIn("selected_peer is None or selected_peer in relay_addresses", live_p2p_source)
        ...
        self.assertIn("NATIVE_CONTROL_KEEPALIVE_INTERVAL = 45.0", camera_source)
